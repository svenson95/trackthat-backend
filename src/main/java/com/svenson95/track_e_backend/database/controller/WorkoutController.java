...
public class WorkoutController {
  ...
  public List<WorkoutDTO> updateAllWorkouts(
      @PathVariable String userId, @RequestBody List<WorkoutDTO> workouts) {
    return workoutService.updateAllWorkouts(userId, workouts);
  }
